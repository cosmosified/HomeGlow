...
// same characterization tests can run unchanged as the data layer is migrated
// onto Knex + Objection (and, later, a different DB engine) by pointing the
// server at a different DB_ENGINE/DB_PATH.
//
